...
# Example:
# python3 main_standard_evolution.py controller_aggregation particle
...
filename = "evo_run_%s_%s" % (args.controller, args.agent, args.id)
...
def fitness(individual):
	...
	f = sim.batch_run((10,20),5) # Run with 10-20 agents, 5 times
