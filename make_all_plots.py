...
subprocess.call('python3 main_verification.py pfsm_exploration data/pfsm_exploration/training_data_1_1/ -plot -format %s -iterations 2'%args.format, shell=True)
subprocess.call('python3 main_verification.py pfsm_exploration_mod data/pfsm_exploration_mod/training_data_1_1/ -plot -format %s -iterations 10'%args.format, shell=True)
subprocess.call('python3 main_verification.py forage data/forage/training_data_1_1/ -plot -format %s -iterations 0 -n 20'%args.format, shell=True)